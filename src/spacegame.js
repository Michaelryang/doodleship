import { Vector2, isPointColliding } from './types.js';
                    ...
                    for (let y = this.worldObjects.length - 1; y >= 0; --y) {
                        if (this.worldObjects[y] instanceof Asteroid) {
                            if (isPointColliding(this.worldObjects[x].getPosition(), this.worldObjects[y])) {
                                ...
                                let newExplosion = this.explosionFactory.createExplosion(this.worldObjects[y].getPosition(), this.worldObjects[y].size);
                                let newAsteroids = this.worldObjects[y].splitAsteroid();
